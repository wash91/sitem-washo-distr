...
import { useSessionManagement } from '@/context/auth/authHooks.jsx';
import { useUserManagement } from '@/context/auth/authManagement.jsx';
import { useAdminUserManagement } from '@/context/auth/useAdminUserManagement.jsx';
...
export const useAuthService = () => {
    ...
    const logout = useCallback(async () => {
        console.log("AuthService: Logging out user (Local Mode).");
        setLoadingAuth(true);
        localStorage.removeItem(LOCAL_STORAGE_USER_KEY);
        setUser(null);
        setLoadingAuth(false);
